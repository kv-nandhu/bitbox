...
class CatDrinks extends StatefulWidget {
  const CatDrinks({super.key});

  @override
  State<CatDrinks> createState() => _CatDrinksState();
}

class _CatDrinksState extends State<CatDrinks> {
  icon() => null;
