...
class CatDinner extends StatefulWidget {
  const CatDinner({super.key});

  @override
  State<CatDinner> createState() => _CatDinnerState();
}

class _CatDinnerState extends State<CatDinner> {
  icon() => null;
